      ...
      (fun acc element ->
        ...
        let+ id =
          ...
          | Float | Float2 | Float3 | Float4 ->
            ...
            let+ _ =
              Gl.vertex_attrib_pointer id (element_count element.typ) Gl.Float element.normalized
          ...
          | Int | Int2 | Int3 | Int4 ->
            let* _ = Gl.enable_vertex_attrib_array id in
            let+ _ =
              Gl.vertex_attrib_pointer id (element_count element.typ) Gl.Int element.normalized
                layout.stride element.offset
            in
            id + 1
          | Bool ->
            let* _ = Gl.enable_vertex_attrib_array id in
            let+ _ =
              Gl.vertex_attrib_pointer id (element_count element.typ) Gl.Bool element.normalized
                layout.stride element.offset
            in
            id + 1
          | Mat3 | Mat4 ->
            ...
            let id =
              Array.fold_left
                (fun id i ->
                  ...
                  let* _ = Gl.enable_vertex_attrib_array id in
                  let+ _ =
                    Gl.vertex_attrib_pointer id count Gl.Float element.normalized layout.stride
