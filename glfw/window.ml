...
let window_hint : type hint. hint window_hint -> hint -> unit = function
  | Context_version_major ->
    fun version -> Stubs.Glfw.window_hint Stubs.Glfw.context_version_major version
  | Context_version_minor ->
    fun version -> Stubs.Glfw.window_hint Stubs.Glfw.context_version_minor version
  | Opengl_profile ->
    fun profile ->
      Stubs.Glfw.window_hint Stubs.Glfw.opengl_profile @@ opengl_profile_to_glfw_constant profile
