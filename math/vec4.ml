...
let zeros elt =
  Genarray.init (Base.kind elt) c_layout [| 4 |] (fun _ -> Base.zero elt)

let ones elt =
  Genarray.init (Base.kind elt) c_layout [| 4 |] (fun _ -> Base.one elt)
...
let _vec_op :
 ...
 fun op v1 v2 ->
  if Genarray.kind v1 <> Genarray.kind v2 then
    ...
    Array1.unsafe_set arr 0
      (op_ (Array1.unsafe_get arr1 0) (Array1.unsafe_get arr2 0));
    Array1.unsafe_set arr 1
      (op_ (Array1.unsafe_get arr1 1) (Array1.unsafe_get arr2 1));
    Array1.unsafe_set arr 2
      (op_ (Array1.unsafe_get arr1 2) (Array1.unsafe_get arr2 2));
    Array1.unsafe_set arr 3
      (op_ (Array1.unsafe_get arr1 3) (Array1.unsafe_get arr2 3));
    genarray_of_array1 arr
[@@inline]
